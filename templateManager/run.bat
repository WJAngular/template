...
cls
title Installing templateManager Project
...
set MAVEN_OPTS=%MAVEN_OPTS% -Xms512m -Xmx512m -XX:PermSize=256M -XX:MaxNewSize=512m -XX:MaxPermSize=512m -Xdebug -Xrunjdwp:transport=dt_socket,server=y,suspend=n,address=9998
...
title Running templateManager Project in Tomcat 7
...
:ERR
echo.
echo. templateManager Project Installation has failed. See above for details.
pause>nul
